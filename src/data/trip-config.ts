...
export const tripMeta: TripMeta = {
  ...
  homeBase: {
    name: "Hotel Plus Hostel TOKYO ASAKUSA 1",
    japaneseName: "ホテルプラスホステル東京浅草1",
    address: "2-13-1 Kaminarimon, Taito City, Tokyo 111-0034",
    japaneseAddress: "〒111-0034 東京都台東区雷門2丁目13-1",
    nearestStation: "Asakusa Station (Ginza Line, Asakusa Line, Tobu)",
    amenities: [
      "Public Bath (Sento) & Sauna",
      "Free High-Speed Wi-Fi",
      "Luggage Storage",
      "2-min walk to Kaminarimon",
    ],
    mapQuery: "Hotel+Plus+Hostel+TOKYO+ASAKUSA+1",
    coordinates: {
      lat: 35.7118,
      lng: 139.7967,
    },
  ...
  flights: {
    outbound: {
      ...
      arrivalTime: "11:45 AM (approx)",
      notes: "Terminal 1 or 2 · Booked & paid · Access Express to Asakusa",
    },
    inbound: {
      code: "Flight NRT → MNL",
      route: "Tokyo Narita (NRT) to Manila (MNL)",
      departureTime: "01:45 PM",
      arrivalTime: "05:30 PM (approx)",
      notes: "Check out by 8:15 AM · Depart Asakusa by 8:30 AM",
    },
  },
  emergencyContacts: [
    {
...
export const itineraryDays: ItineraryDay[] = [
    ...
    sunPlan: [
      {
        ...
        desc: "Morning flight from Manila to Narita. Have Visit Japan Web QR codes ready.",
        icon: "✈️",
      ...
      },
      {
        ...
        desc: "Hotel Plus Hostel TOKYO ASAKUSA 1 (2-13-1 Kaminarimon). Freshen up and reset.",
        icon: "🏨",
        badges: ["Home Base"],
      },
      {
      ...
      {
        time: "18:00",
        title: "Sumida River Golden Hour",
    ...
    rainPlan: [
      {
        time: "06:10",
        title: "Flight MNL → NRT",
        desc: "Monitor airline and Keisei train status in case of weather delays.",
        icon: "✈️",
        badges: ["Booked & paid", "Transit"],
      },
      {
        ...
        desc: "Drop bags, dry off, and enjoy a warm drink at the hotel lounge.",
        icon: "🏨",
  ...
  },
  {
    ...
    sunPlan: [
      {
        ...
        desc: "Final room check for passports, chargers, and Suica cards. Quick checkout at Hotel Plus Hostel.",
        icon: "🏨",
        badges: ["Check-out"],
      },
      {
        ...
        desc: "Walk to Asakusa Station and board Access Express bound for Narita Airport. Confirm terminal before boarding.",
        icon: "🚆",
        badges: ["Direct Airport Train"],
      },
      {
        time: "10:30",
        title: "Narita Airport Check-in & Security",
        desc: "Baggage drop, security clearance, and last-minute tax-free sweets shopping (Tokyo Banana, Royce', KitKats).",
        icon: "🛍️",
        badges: ["Duty Free"],
      },
      {
        ...
        desc: "Flight back home to Manila. Safe travels and unforgettable Tokyo memories!",
        icon: "✈️",
        badges: ["Booked & paid"],
      },
    ],
    rainPlan: [
      ...
      {
        time: "08:15",
        title: "Access Express to Narita",
      ...
      {
        time: "10:15",
        title: "Airport Check-in & Covered Lounges",
        desc: "Relax in terminal cafes and complete final tax-free souvenir shopping.",
        icon: "☕",
        badges: ["Airport Lounge"],
      },
      {
        time: "13:45",
        title: "Flight NRT → MNL Departure",
    ...
    weatherAdvice: {
      sun: "Departure timing gives a generous 3+ hour airport buffer for effortless baggage drop and gate arrival.",
...
export const transportRoutes: TransportRoute[] = [
  {
    id: "narita-arrival",
    title: "Narita Airport → Hotel Plus Hostel Asakusa",
    dateOrFrequency: "Tue, Sep 1 — Arrival",
    ...
    legs: [
      ...
      {
        step: 3,
        title: "Exit toward Kaminarimon",
        detail:
          "Exit Asakusa Station (follow Kaminarimon exit signs) and walk 2 minutes to Hotel Plus Hostel TOKYO ASAKUSA 1 (2-13-1 Kaminarimon).",
        badges: ["2-min Walk", "Kaminarimon Exit"],
      },
    ],
    ...
    legs: [
      {
        ...
        detail: "Walk from the Kaminarimon hotel down to Kuramae Station Oedo Line entrance.",
  ...
  {
    id: "hotel-departure",
    title: "Hotel Asakusa → Narita Airport Departure",
    dateOrFrequency: "Mon, Sep 7 — 1:45 PM Flight",
    estimatedTime: "55–80 min",
    totalFare: "≈ ¥1,300–1,350",
    transfers: 0,
    icon: "🛫",
    legs: [
      ...
      {
        step: 2,
        title: "Board Keisei Access Express to Narita Airport",
        detail:
          "Confirm destination board shows Narita Airport (成田空港). Ride direct with no transfer to Terminal 2·3 or Terminal 1.",
        badges: ["Direct Airport Train", "0 Transfers"],
      },
    ],
    tips: "Leaving Asakusa by 8:30 AM ensures arrival around 9:45 AM, providing a generous 4-hour cushion for check-in and duty-free shopping.",
  },
];
