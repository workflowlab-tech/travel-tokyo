...
export const tripMeta: TripMeta = {
  ...
  homeBase: {
    ...
    totalCostJPY: 89525,
    totalCostPHP: 33157,
    paymentStatus: "Pay Later (Confirmed Booking)",
  ...
  flights: {
    outbound: {
      ...
      passengerPNRs: [
        { name: "Traveler 1 (Lead)", pnr: "TK2026A" },
        { name: "Traveler 2", pnr: "TK2026B" },
        { name: "Traveler 3", pnr: "TK2026C" },
        { name: "Traveler 4", pnr: "TK2026D" },
        { name: "Traveler 5", pnr: "TK2026E" },
      ],
      lounge: {
        airport: "Manila NAIA",
        terminal: "Terminal 3",
        loungeName: "NAIA T3 VIP Lounge",
        primaryCard: "Primary Travel Card (Visa)",
        backupCard: "Secondary Travel Pass (Mastercard)",
        notes: "Present boarding pass + travel card at lounge reception",
      },
    ...
    inbound: {
      ...
      lounge: {
        ...
        primaryCard: "Primary JCB / Visa",
        backupCard: "Travel Mastercard",
  ...
  travelers: [
    {
      id: "trav-1",
      travelerName: "Traveler 1 (Lead Planner)",
      pnr: "TK2026A",
      passportImage: "/images/destinations/day1-asakusa.jpg",
      visaNumber: "FB-2026-DEMO1",
      visaImage: "/images/destinations/day1-asakusa.jpg",
  ...
  emergencyContacts: [
    {
      ...
      number: "110",
      desc: "Urgent accident / crime rescue. English interpretation available nationwide 24/7.",
      isDialable: true,
    },
    {
      ...
      number: "119",
      desc: "Emergency medical rescue or fire department nationwide.",
      isDialable: true,
    },
    {
      label: "JNTO Japan Visitor Hotline",
      japaneseLabel: "日本政府観光局ホットライン",
      number: "050-3816-2787",
      desc: "Official 24/7 tourist helpline (English, Japanese, Chinese, Korean). Overseas: +81-50-3816-2787.",
      isDialable: true,
      hours: "24/7 Nationwide",
    },
    {
      label: "Police Non-Emergency Advice",
      japaneseLabel: "警察相談専用電話",
      number: "#9110",
      desc: "Non-urgent police consultation, safety guidance, and lost property advice.",
      isDialable: true,
    },
    {
      label: "Tokyo Medical Info (Himawari)",
      japaneseLabel: "ひまわり医療情報",
      number: "03-5285-8181",
      desc: "English-speaking doctor, clinic directory and medical consultation in Tokyo.",
      isDialable: true,
  ...
  emergencyPhrases: [
    ...
    {
      jp: "パスポートを紛失しました",
      romaji: "Pasupōto o funshitsu shimashita",
  ...
  emergencyPlaybooks: [
    {
      ...
      icon: "🛂",
      priority: "high",
      description: "Immediate recovery protocol for lost international travel documents in Japan.",
      steps: [
    ...
    {
      id: "lost-item",
      title: "Lost Phone, IC Card, or Bag",
      icon: "📱",
      priority: "medium",
      description: "Japan has an 80%+ return rate for lost items turned into police and transit stations.",
      steps: [
        "1. For trains/subways: Visit the nearest station master office (駅事務室) and describe the train line, car number, and time.",
        "2. For Tokyo Metro: Call the Tokyo Metro Lost & Found Center at Iidabashi: 0570-000-911.",
        "3. For street / restaurant: Visit the nearest Koban police box to check the nationwide lost property database.",
      ],
    },
    {
      id: "medical",
      title: "Medical Illness or Injury",
      icon: "🏥",
      priority: "high",
      description: "Access English-speaking medical care in Tokyo.",
      steps: [
        "1. In life-threatening emergencies, dial 119 immediately for an ambulance rescue.",
        "2. For non-critical care, call Himawari (03-5285-8181) to locate English-speaking hospitals (e.g. St. Luke's International Hospital).",
        "3. Contact your Travel Insurance emergency assistance line to arrange direct billing or payment guarantee.",
      ],
    },
  ],
  defaultCurrencies: {
    ...
    plannedBudgetHome: 150000,
    plannedBudgetDest: 405000,
    initialCashDest: 100000,
    ...
    sunPlan: [
      {
        ...
        desc: "Check-in at NAIA T3. Relax at airport lounge using primary travel card before boarding.",
        icon: "☕",
        badges: ["Lounge Access", "Departure Gate"],
        image:
      ...
      },
      {
        ...
        desc: "Morning flight to Tokyo Narita. 5 Passengers Confirmed · Booking Ref: TK2026-FLIGHT.",
        icon: "✈️",
